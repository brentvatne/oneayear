/** TODO: THIS IS A CUSTOM BUILT ANGULAR IN ORDER TO SUPPORT SVG NAMESPACE
  * ELEMENTS! REPLACE WHEN THIS BUG IS FIXED SOMEWHERE IN 1.3! This interface
  * will need to change on direcives - most likely directiveNS will not be
  * required.
  *
  * Patch & related issue:
  * https://github.com/angular/angular.js/pull/5419
  */

/**
 * @license AngularJS v1.2.10-build.local+sha.14f3306
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.10-build.local+sha.14f3306/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.10-build.local+sha.14f3306',    // all of these placeholder strings will be replaced by grunt's
